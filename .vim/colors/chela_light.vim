...
hi label        guibg=#fafafa   guifg=#2222ff   gui=none

hi preproc      guibg=#fafafa   guifg=#2222ff   gui=none
hi include      guibg=#fafafa   guifg=#2222ff   gui=none
...
hi matchparen   guibg=#339933   guifg=#ffffff   gui=none
