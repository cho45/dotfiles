...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    "VisualNOS
    call <SID>X("WarningMsg", "cc9933", "", "")
    "WildMenu
    "Menu
    "Scrollbar
    "Tooltip
    call <SID>X("Pmenu", "222222", "ffffff", "reverse")
    call <SID>X("PmenuSel", "666666", "ffffff", "reverse")
    call <SID>X("PmenuSbar", "cccccc", "", "")
    ...
    call <SID>X("Error", "cc9933", "ffffff", "reverse")
