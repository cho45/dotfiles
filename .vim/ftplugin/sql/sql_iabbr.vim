...
inoreabbr <silent> <buffer> limit <C-R>=SqlIab_ReplaceConditionally('limit', 'LIMIT')<CR>
inoreabbr <silent> <buffer> offset <C-R>=SqlIab_ReplaceConditionally('offset', 'OFFSET')<CR>
